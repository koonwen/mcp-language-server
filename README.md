...
[![Go Tests](https://github.com/koonwen/mcp-language-server/actions/workflows/go.yml/badge.svg)](https://github.com/koonwen/mcp-language-server/actions/workflows/go.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/koonwen/mcp-language-server)](https://goreportcard.com/report/github.com/koonwen/mcp-language-server)
[![GoDoc](https://pkg.go.dev/badge/github.com/koonwen/mcp-language-server)](https://pkg.go.dev/github.com/koonwen/mcp-language-server)
[![Go Version](https://img.shields.io/github/go-mod/go-version/isaacphi/mcp-language-server)](https://github.com/koonwen/mcp-language-server/blob/main/go.mod)
...
2. **Install or update this server**: `go install github.com/koonwen/mcp-language-server@latest`
...
```bash
git clone https://github.com/koonwen/mcp-language-server.git
